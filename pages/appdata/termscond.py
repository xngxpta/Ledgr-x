...
hide_st_style = """ <style> div[data-testid="metric-container"]
{ background-color: rgba(155, 136, 225, 0.1); border: 1px solid rgba(128, 131,
225, 0.1); padding: 5% 5% 5% 10%; border-radius: 10px; color: rgb(30, 103,
119); overflow-wrap: break-word; }

/* breakline for metric text         */ div
   [data-testid="metric-container"] > label[data-testid="stMetricLabel"] > div
   { overflow-wrap: break-word; white-space: break-spaces; color: yellow; }
...
email or other type of communication between you and  ": Ledgr Inc."
| "www.alphaLedgr.com" | "alphaLedgr Technologies Ltd. :" or the Ledgr WebApp.
...
results in the need for servicing, repair or correction of equipment or data,
...
These Terms & Conditions are a contract between you and ": Ledgr Inc."
| "www.alphaLedgr.com" | "alphaLedgr Technologies Ltd. :" or "Ledgr" 's
(referred to in these Terms & Conditions as " ", "us", "we" or "our"), the
provider of the  website and the services accessible from the website(which are
collectively referred to in these Terms & Conditions as the " Service"). 
...
using our WebApp & services etc., registering an account, or making a purchase,
...
This Agreement will terminate immediately, without prior notice from  "Ledgr",
...
Without limitation to the foregoing, provides no warranty or undertaking, and
...
defects can or will be corrected. Without limiting the foregoing, neither nor
any provider makes any representation or warranty of any kind, express or
implied: 
...
Notwithstanding any damages that you might incur, the entire liability of and
...
event shall  ": Ledgr Inc." | "www.alphaLedgr.com" | "alphaLedgr Technologies
...
Ltd. :", third-party software and/or third-party hardware used with the , or
...
together with the Privacy Policy and any other legal notices published by  on
the Services, shall constitute the entire agreement between you and  ": Ledgr
Inc." | "www.alphaLedgr.com" | "alphaLedgr Technologies Ltd. :" concerning the
...
The Agreement constitutes the entire agreement between you and regarding your
...
The term "dispute" means any dispute, action, or other controversy between you
...
(or participate in as a party or class member) all disputes in court before a
judge or jury. 
...
any compensation or credit to you whatsoever. ": Ledgr Inc."
| "www.alphaLedgr.com" | "alphaLedgr Technologies Ltd. :"  and its affiliates
...
merchandise provided through or accessible via the Service. Without limiting
the foregoing, specifically disclaims all warranties and representations in any
...
given by or any of its affiliates, employees, officers, directors, agents, or
